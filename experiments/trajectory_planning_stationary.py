...
if __name__ == "__main__":
    ...
    traj = obsl.get_obstacle_trajectory(config.sim_iterations,"stationary")[:horizon]  # switch off obstacle movement
    ...
    sim.obstacles = False  # switch off obstacle movement
    sim.simulate() 
    obsl.reset_xmls()
